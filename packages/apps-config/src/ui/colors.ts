...
const chainSetheum = 'linear-gradient(90deg, rgba(200,26,198,1) 0%, rgba(28,54,213,1) 50%, rgba(32,240,230,1) 100%)';
...
const nodeSetheum = chainSetheum;
